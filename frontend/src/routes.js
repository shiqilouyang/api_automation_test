...
let routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: '/title', component: About, iconCls:'fa fa-address-card', name: '所有文章'},
            { path: '/tianyan', component: About, iconCls:'fa fa-address-card', name: '天眼测试工具管理平台'},
            { path: '/nerpa', component: About, iconCls:'fa fa-address-card', name: 'nerpa水龙头'},
            { path: '/calibration', component: About, iconCls:'fa fa-address-card', name: 'calibration水龙头'},
