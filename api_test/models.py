...
class Pressure(models.Model):
    ...
    data = models.CharField(max_length=4096, blank=True, null=True, verbose_name="请求体")
    header = models.CharField(max_length=1024, blank=True, null=True, verbose_name="请求头")
    aux_id = models.CharField(max_length=50, blank=True, null=True, verbose_name="进程ID")
